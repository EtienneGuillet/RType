...
namespace b12software {
    ...
    namespace containers {
        ...
        public:
             ...
             */
            virtual size_t read(void *toWrite, size_t size);
            /*!
             ...
             */
            virtual size_t read(std::string &str, const char *delim, size_t size);
             ...
             */
            [[nodiscard]] virtual size_t getNbBufferedBytes() const;

            /*!
             * @brief Get the size of this buffer
             * @return The size of the buffer
             */
            [[nodiscard]] virtual size_t getBufferSize() const;
