...
namespace ecs {
    ...
    namespace components {
        ...
        public:
            ColliderComponent(const b12software::maths::Vector2D &size = b12software::maths::Vector2D(50, 50), const b12software::maths::Vector2D &offset = b12software::maths::Vector2D());
