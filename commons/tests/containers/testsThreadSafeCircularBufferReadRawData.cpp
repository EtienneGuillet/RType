...
** b12networking
** File description:
** testsThreadSafeCircularBufferReadRawData.cpp
*/

/* Created the 28/10/2019 at 14:20 by julian.frabel@epitech.eu */
...
Test(threadsafecircularbuffer_read, read_raw_data,
     .timeout=10,
     .description="Test the reading to raw data from the thread safe buffer",
     .init=init,
     .fini=fini
)
{
...
Test(threadsafecircularbuffer_read, read_raw_data_after_overflow,
     .timeout=10,
     .description="Test the reading to raw data from the thread safe buffer after overflow",
     .init=init,
     .fini=fini
)
{
...
Test(threadsafecircularbuffer_read, read_more_data_that_hold_data,
     .timeout=10,
...
)
{
    ...
    } catch (b12software::exception::NotEnoughDataInCircularBufferException &e) {
        return;
    }
    cr_assert_fail("Was expecting a NotEnoughDataInCircularBufferException but got %lu bytes readed instead.", readed);
}

Test(threadsafecircularbuffer_read, read_data_to_null_pointer,
     .timeout=10,
     .description="Test the reading of data to a null thread safe buffer",
     .init=init,
     .fini=fini
)
{
